...
Ever wondered why in JavaScript you can call your functions before they're declared? Then read on!

##### tl;dr
Conceptually speaking, hoisting is the movement of declaractions - variables and functions. - to the top of their scope, be it local or global, while assignments are left in place. What really happens, is that during compile time, the declarations are put into memory first, but remain in place in your code.
...
The downside is that `const` and `let` do not get hoisted.
