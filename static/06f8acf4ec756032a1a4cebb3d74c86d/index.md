...
Classes in JavaScript are in fact special functions, and just as you can defined functions with declaration and expression, the class syntax has the same two components: [class expressions and class declarations][function-class].

Unlike functions and variables, classes _do not_ get hoisted, either declared through declaration or expression. You need to declare your class before you can use it.
